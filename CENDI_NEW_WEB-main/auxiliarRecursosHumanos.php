...
<head>
    ...
    <title>Técnico laboral como Auxiliar en Recursos Humanos| CENDI</title>
        <style>
        .text-primary {
...
<body data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="70">
    ...
    <div class="position-relative overflow-hidden mb-4">
        <div class="banner-img" style="background-image: url('img/slides/recursos-humanos.jpg'); height: 400px; background-size: cover; background-position: center;"></div>
        <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center" style="background: rgba(9, 32, 50, 0.7);">
            <div class="text-center text-white">
                ...
                <h1 class="display-4 fw-bold mb-4 text-white">Técnico laboral como Auxiliar en Recursos Humanos</h1>
                                    ...
                                    <div class="tab-content bg-white p-4 rounded shadow-sm" id="nav-tabContent">
                                        <div class="tab-pane fade show active" id="egreso" role="tabpanel" aria-labelledby="list-home-list">
                                            ...
                                            <ul class="list-unstyled">
                                                <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Auxiliar de personal</li>
                                                <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Auxiliar de relaciones laborales</li>
                                                <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Auxiliar de selección de personal</li>
                                                <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Auxiliares de nómina y prestaciones</li>
                                        ...
                                        <div class="tab-pane fade" id="plan" role="tabpanel" aria-labelledby="list-profile-list">
                                            ...
                                            El programa Técnico laboral como Auxiliar en Recursos Humanos, cuenta con un total de 1.200 horas, distribuidas en tres niveles de formación:
                                            </p>
                                            <ul class="list-unstyled">
                                        ...
                                        <div class="tab-pane fade" id="transversal" role="tabpanel" aria-labelledby="list-obligatorios-list">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <ul class="list-unstyled">
                                                        <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Proceso Administrativo</li>
                                                        <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Contabilidad General</li>
                                                        <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Gestión Humana I</li>
                                                        <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Gestión Humana II</li>                                                        </li>
                                                        <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Seguridad Social</li>
                                                        <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Psicología Organizacional</li>
                                                        <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Seguridad y Salud en el Trabajo</li>
                                                        <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Perfiles de Cargos</li>
                                                    </ul>
                                                </div>  
                                                 ...
                                                 <div class="col-md-6">
                                                    <ul class="list-unstyled">
                                                        ...
                                                        <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Negociación Y Conflicto Laboral</li>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <div class="text-center mb-4">
                        ...
                        <h5 class="card-subtitle mb-3 text-primary">TÉCNICO LABORAL POR COMPETENCIAS COMO AUXILIAR EN RECURSOS HUMANOS</h5>
                        <div class="alert alert-light ">
                            <strong>NO CONDUCE A TITULO PROFESIONAL</strong>
                        </div>

                        <p class="mb-2">Certiﬁcación CELAC en Norma Técnica Colombiana NTC 5581 y NTC 5555.</p>
                    ...
                    <div class="d-flex justify-content-center align-items-center flex-wrap gap-4">
                        ...
                        <img src="img/logosCelac/celac-recurso-humanos.png" alt="celac" class="img-fluid" style="height: 100px; width: auto;">
                    </div>
                </div>
            </div>
        </div>
