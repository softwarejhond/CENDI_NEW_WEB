...
<head>
    ...
    <title>Técnico Laboral en Manejo de Herramientas para Codificación de Software | CENDI</title>
        <style>
        .text-primary {
...
<body data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="70">
    ...
    <div class="position-relative overflow-hidden mb-4">
        <div class="banner-img" style="background-image: url('img/slides/desarrollo.jpg'); height: 400px; background-size: cover; background-position: center;"></div>
        <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center" style="background: rgba(9, 32, 50, 0.7);">
            <div class="text-center text-white">
                ...
                <h1 class="display-4 fw-bold mb-4 text-white">Técnico Laboral en Manejo de Herramientas para Codificación de Software</h1>
                <h5 style="text-align: center; color: white;">Lic. de Funcionamiento N° 05293 de Junio 25 de 2009<br>
                Lic. de Funcionamiento N° 201750021377 de Diciembre 19 de 2017 Resolución de la Secretaria de Educación: <br>N° 202550033460 DE 16/05/2025</h5>
                                    ...
                                    <div class="tab-content bg-white p-4 rounded shadow-sm" id="nav-tabContent">
                                        <div class="tab-pane fade show active" id="egreso" role="tabpanel" aria-labelledby="list-home-list">
                                            ...
                                            <ul class="list-unstyled">
                                                <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Asistente en análisis y desarrollo de sistemas de información</li>
                                                <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Asistente en análisis y desarrollo de software</li>
                                                <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Auxiliar en sistemas</li>
                                                <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Auxiliar en sistemas informáticos</li>
                                        ...
                                        <div class="tab-pane fade" id="plan" role="tabpanel" aria-labelledby="list-profile-list">
                                            ...
                                            El programa Técnico Laboral en Manejo de Herramientas para Codificación de Software, cuenta con un total de 1.200 horas, distribuidas en tres niveles de formación: 
                                            </p>
                                            <ul class="list-unstyled">
                                        ...
                                        <div class="tab-pane fade" id="transversal" role="tabpanel" aria-labelledby="list-obligatorios-list">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <ul class="list-unstyled">
                                                        <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Entorno de Programación</li>
                                                        <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Habilidades para solucionar problemas concretos</li>
                                                        <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Mantenimiento de equipos de computo</li>
                                                        <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Entorno de Desarrollo</li>
                                                       
                                                    </ul>
                                                </div>
                                                <!-- <div class="col-md-6">
                                                    <ul class="list-unstyled">
                                                        <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Levantar Requisitos de la solución de software</li>
                                                        <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Evaluar requisitos de la solución de software</li>
                                                        <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Diseñar la solución de software</li>
                                                        <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Implementar la solución de software</li>
                                                       
                                                    </ul>
                                                </div>
                                                <div class="col-md-6">
                                                    <ul class="list-unstyled">
                                                        <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Controlar la calidad del servicio de software</li>
                                                        <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Mantenimiento de Equipos de Computo</li>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <div class="text-center mb-4">
                        ...
                        <h5 class="card-subtitle mb-3 text-primary">TÉCNICO LABORAL POR COMPETENCIAS EN MANEJO DE HERRAMIENTAS PARA CODIFICACIÓN DE SOFTWARE</h5>
                        <div class="alert alert-light ">
                            <strong>NO CONDUCE A TITULO PROFESIONAL</strong>
                        </div>

                        <p class="mb-2">Certiﬁcación CELAC en Norma Técnica Colombiana NTC 5666 y NTC 5555.</p>
                    ...
                    <div class="d-flex justify-content-center align-items-center flex-wrap gap-4">
                        ...
                        <img src="img/logosCelac/celac-desarrollo-software.png" alt="celac" class="img-fluid" style="height: 100px; width: auto;">
                    </div>
                </div>
            </div>
        </div>
