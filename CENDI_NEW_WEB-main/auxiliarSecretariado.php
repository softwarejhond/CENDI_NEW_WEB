...
<head>
    ...
    <title>Técnico Laboral como Secretaria (o) General | CENDI</title>
        <style>
        .text-primary {
...
<body data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="70">
    ...
    <div class="position-relative overflow-hidden mb-4">
        <div class="banner-img" style="background-image: url('img/slides/secretariado.jpg'); height: 400px; background-size: cover; background-position: down;"></div>
        <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center" style="background: rgba(9, 32, 50, 0.7);">
            <div class="text-center text-white">
                ...
                <h1 class="display-4 fw-bold mb-4 text-white">Técnico Laboral como Secretaria (o) General</h1>
                                    ...
                                    <div class="tab-content bg-white p-4 rounded shadow-sm" id="nav-tabContent">
                                        <div class="tab-pane fade show active" id="egreso" role="tabpanel" aria-labelledby="list-home-list">
                                            ...
                                            <ul class="list-unstyled">
                                                <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Auxiliar de nómina y prestaciones</li>
                                                <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Auxiliar administrativa</li>
                                                <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Auxiliar de personal</li>
                                                <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Auxiliar de archivo y registro</li>
                                                <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Digitadores</li>
                                                <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Transcriptores y relatores</li>
                                        ...
                                        <div class="tab-pane fade" id="plan" role="tabpanel" aria-labelledby="list-profile-list">
                                            ...
                                            distribuidas en tres niveles de formación: 
                                            </p>
                                            <ul class="list-unstyled">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <ul class="list-unstyled">
                                                        ...
                                                        <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Organizar reuniones</li>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <div class="text-center mb-4">
                        ...
                        <h5 class="card-subtitle mb-3 text-primary">TÉCNICO LABORAL POR COMPETENCIAS COMO SECRETARIA(O) GENERAL.</h5>
                    ...
                    <div class="d-flex justify-content-center align-items-center flex-wrap gap-4">
                        ...
                        <img src="img/logosCelac/celac-secretariado-gerencial.png" alt="celac" class="img-fluid" style="height: 100px; width: auto;">
                    </div>
                </div>
            </div>
        </div>
