...
<head>
    ...
    <title>Técnico laboral como Auxiliar de Sistemas Informáticos| CENDI</title>
        <style>
        .text-primary {
...
<body data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="70">
    ...
    <div class="position-relative overflow-hidden mb-4">
        <div class="banner-img" style="background-image: url('img/slides/sistemas.jpg'); height: 400px; background-size: cover; background-position: center;"></div>
        <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center" style="background: rgba(9, 32, 50, 0.7);">
            <div class="text-center text-white">
                ...
                <h1 class="display-4 fw-bold mb-4 text-white">Técnico Laboral como Auxiliar de Sistemas Informáticos</h1>
                                    ...
                                    <div class="tab-content bg-white p-4 rounded shadow-sm" id="nav-tabContent">
                                        <div class="tab-pane fade show active" id="egreso" role="tabpanel" aria-labelledby="list-home-list">
                                            ...
                                            <ul class="list-unstyled">
                                                <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Técnicos en operaciones de tecnología de la información y las comunicaciones.</li>
                                                <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Técnicos en asistencia y soporte al usuario de tecnología de la información y las comunicaciones.</li>
                                                <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i> Técnicos en redes y sistemas de computación.</li>
                                                <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Técnicos de la Web.</li>
                                        </div>
                                        <div class="tab-pane fade" id="plan" role="tabpanel" aria-labelledby="list-profile-list">
                                            ...
                                            <p class="text-justify">
                                                El programa Técnico Laboral como Auxiliar de Sistemas Informáticos, cuenta con un total de 1.200 horas, distribuidas en tres niveles de formación:                                            </p>
                                            <ul class="list-unstyled">
                                        ...
                                        <div class="tab-pane fade" id="transversal" role="tabpanel" aria-labelledby="list-obligatorios-list">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <ul class="list-unstyled">
                                                        <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Sistemas Operacionales I</li>
                                                        <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Sistemas Operacionales II</li>
                                                        <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Redes I</li>
                                                        <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Redes II</li>
                                                ...
                                                <div class="col-md-6">
                                                    <ul class="list-unstyled">
                                                        ...
                                                        <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Mantenimiento de Hardware y Software</li>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <div class="text-center mb-4">
                        ...
                        <h5 class="card-subtitle mb-3 text-primary">TÉCNICO LABORAL POR COMPETENCIAS COMO AUXILIAR DE SISTEMAS.</h5>
