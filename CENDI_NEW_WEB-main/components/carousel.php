...
$programas = [
    ...
    [
        'curso' => ['titulo' => 'Técnico Laboral en Reservas y Asistencia de Servicios Turísticos', 'descripcion' => 'Brinda una experiencia excepcional en servicios de hotelería'],
        'mensaje' => ['titulo' => 'SERVICIOS TURÍSTICOS', 'subtitulo' => 'Hospitalidad y Servicio', 'mensaje' => 'Crea experiencias memorables en la industria hotelera'],
        'imagen' => 'img/slides/hoteleria.jpg'
    ],
    [
        'curso' => ['titulo' => 'Técnico Laboral en Manejo de Herramientas para Codificación de Software', 'descripcion' => 'Crea soluciones tecnológicas innovadoras'],
        'mensaje' => ['titulo' => 'CODIFICACIÓN DE SOFTWARE', 'subtitulo' => 'Código y Creatividad', 'mensaje' => 'Programa el futuro con soluciones innovadoras'],
