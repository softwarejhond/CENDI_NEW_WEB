...
<head>
    ...
    <title>Técnico Laboral como Auxiliar en Servicio al Cliente y Telemercadeo| CENDI</title>
        <style>
        .text-primary {
...
<body data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="70">
    ...
    <div class="position-relative overflow-hidden mb-4">
        <div class="banner-img" style="background-image: url('img/slides/atencion-cliente.jpg'); height: 400px; background-size: cover; background-position: down;"></div>
        <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center" style="background: rgba(9, 32, 50, 0.7);">
            <div class="text-center text-white">
                ...
                <h1 class="display-4 fw-bold mb-4 text-white">Técnico Laboral como Auxiliar en Servicio al Cliente y Telemercadeo</h1>
                                    ...
                                    <div class="tab-content bg-white p-4 rounded shadow-sm" id="nav-tabContent">
                                        <div class="tab-pane fade show active" id="egreso" role="tabpanel" aria-labelledby="list-home-list">
                                            ...
                                            <ul class="list-unstyled">
                                                <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Recepcionistas y operadores de conmutador</li>
                                                <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Auxiliares de banca, seguros y otros servicios financieros</li>
                                                <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Auxiliares de publicación y aﬁnes</li>
                                                <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Vendedores de mostrador</li>
                                                <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Empleados de ventas y servicios de líneas aéreas, marítimas y terrestres</li>
                                                <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Asesor de servicio al cliente</li>
                                                <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Operador de call center y contac center</li>
                                                <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Gestor de tele cobranza</li>
                                                <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Atención al cliente interno y externo</li>
                                        </div>
                                        <div class="tab-pane fade" id="plan" role="tabpanel" aria-labelledby="list-profile-list">
                                            ...
                                            <p class="text-justify">
                                                El programa técnico laboral como auxiliar en Servicio al Cliente y Telemercadeo, cuenta con un total de 1.200 horas, distribuidas en tres niveles de formación:
                                            </p>
                                            <ul class="list-unstyled">
                                        ...
                                        <div class="tab-pane fade" id="transversal" role="tabpanel" aria-labelledby="list-obligatorios-list">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <ul class="list-unstyled">
                                                        <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Servicio al Cliente I</li>
                                                        <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Servicio al Cliente II</li>
                                                        <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Digitación</li>
                                                        <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Estadística</li>
                                                        <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Venta de productos y servicios</li>
                                                    </ul>
                                                </div>
                                                <div class="col-md-6">
                                                    <ul class="list-unstyled">
                                                        <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i>Seguridad y Salud en el Trabajo</li>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <div class="text-center mb-4">
                        ...
                        <h5 class="card-subtitle mb-3 text-primary">TÉCNICO LABORAL POR COMPETENCIAS COMO AUXILIAR EN SERVICIO AL CLIENTE <br> Y TELEMERCADEO.</h5>
